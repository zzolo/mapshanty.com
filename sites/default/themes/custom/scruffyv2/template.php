...
function scruffyv2_preprocess_page(&$vars) {
...
function scruffyv2_feed_icon($url, $title) {
  return '<a href="'. check_url($url) .'" class="subscribe" title="' . $title . '">'. t('Subscribe') .'</a>';
}


function scruffyv2_preprocess_node(&$vars) {
...
function scruffyv2_gmap_marker_popup($label) {
  return '<div class="scruffy-label">' . $label . '</div>';
}
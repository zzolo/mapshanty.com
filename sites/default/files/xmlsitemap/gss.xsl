  ...
  <xsl:template match="/">
    <html>
      <head>
        ...
        <link href="/sites/mapshanty.com/modules/xmlsitemap/gss/gss.css" type="text/css" rel="stylesheet"/>
        <script src="/sites/mapshanty.com/modules/xmlsitemap/gss/gss.js"></script>
      </head>

<?php
// $Id: search-theme-form.tpl.php,v 1.1.2.1 2008/09/24 14:56:36 eaton Exp $
 ...
 */
?>
<input class="text" type="text" name="search_theme_form" id="s" />
<input class="submit" name="op" value="Submit" type="image" src="<?php print '/' . $theme_directory . '/img/submit.jpg'; ?>" />
